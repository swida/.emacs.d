...
(cl-defmethod my-xref-backend-identifier-at-point (_backend)
  (let ((thing (thing-at-point 'symbol)))
    (and thing (propertize thing
                           'identifier-at-point t))))
(cl-defmethod my-xref-backend-identifier-completion-table (_backend))
(cl-defmethod my-xref-backend-definitions (_backend identifier)
